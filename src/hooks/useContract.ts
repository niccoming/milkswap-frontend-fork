...
import {
  ...
  getBusdAddress,
  getPublicPurchaseAddress,
  getBiddingPurchaseAddress,
...
import publicPurchase from 'config/abi/publicPurchase.json'
import biddingPurchase from 'config/abi/biddingPurchase.json'
...
export const useICake = () => {
  return useERC20(getICakeAddress())
}
...
export const usePublicPurchase = () => {
  const abi = (publicPurchase as unknown) as AbiItem
  return useContract(abi, getPublicPurchaseAddress())
}

export const useBiddingPurchase = () => {
  const abi = (biddingPurchase as unknown) as AbiItem
  return useContract(abi, getBiddingPurchaseAddress())
}
