...
const CardFooter: React.FC<Props> = ({
  ...
  const totalLiquidity = totalStaked && quoteTokenPriceUsd?totalStaked.times(quoteTokenPriceUsd):new BigNumber(0)
      ...
      {isOpen && (
        <Details>
          <Row style={{ marginBottom: '4px' }}>
            ...
            <Balance fontSize="14px" isDisabled={isFinished} value={getBalanceNumber(totalLiquidity)} />
          </Row>
          {blocksUntilStart > 0 && (
            <Row>
              <FlexFull>
          ...
          <TokenLink href={`https://bscscan.com/token/${pool.stakingTokenAddress}`} target="_blank">
